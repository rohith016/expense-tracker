                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('expenses.update', $expense) }}" method="post">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="amount" class="block mt-1 w-full" type="text" name="amount" :value="old('amount', $expense -> amount)"  autofocus autocomplete="amount"  placeholder="Amount" />
                            <x-input-error :messages="$errors->get('amount')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="description" :value="__('Description')" />
                            <x-text-input id="description" class="block mt-1 w-full" type="text" name="description" :value="old('description', $expense -> description)"  autofocus autocomplete="description" placeholder="Description" />
